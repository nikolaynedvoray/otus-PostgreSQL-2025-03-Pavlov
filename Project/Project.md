### Создание и настройка отказоустойчивого кластера Postgresql на базе Patroni.

## Вводная часть.
Все работы выполнялись в облаке Cloud.ru платформа Advanced.  
Для развертывания Postgres использовал VM с выделенными ядрами 2 vCPU, 8 Gb.  
Для развертывания ETCD и Pometheus взял минимальную конфигурацию 1 vCPU, 2 GB. Ядра с переподпиской 1/3.  
PostgreSQL 18 версии.  
ETCD version 3.4.30  
Patroni 4.1.0
